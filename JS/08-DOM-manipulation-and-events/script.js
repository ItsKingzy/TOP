...
btn2.addEventListener("click", () => {
    alert("Hello World");  // We maintain separation of concern here
});

// We could also make the above a function instead, e.g.,
/*
...
btn3.addEventListener("click", function (e) {
    console.log(e.target); // shows the element we are targetting in the console
})
